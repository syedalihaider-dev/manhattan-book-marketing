                    ...
                    <div className={style._flex}>
                        <div className={style.left}>
                            ...
                            <div className={style.cta}>
                                ...
                                <CTA icon="call" link="tel:4156345647" css="bg-transparent border-2 border-white hover:text-pink hover:border-pink [&>img]:brightness-0 [&>img]:invert [&:hover>img]:invert-0 [&:hover>img]:brightness-[inherit]" text="(415) 634-5647" />
                            </div>
                        </div>
                        <div>
